...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-[#A67C52] text-[#F5F3EF] hover:opacity-90 shadow-sm",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline: "border border-[#E5E1D8] bg-transparent hover:bg-[#A67C52]/5 hover:text-[#A67C52]",
        secondary: "bg-[#E9E4DB] text-[#6B6B6B] hover:bg-[#E9E4DB]/80",
        ghost: "hover:bg-[#A67C52]/5 hover:text-[#A67C52]",
        link: "text-[#A67C52] underline-offset-4 hover:underline",
      },
      size: {
